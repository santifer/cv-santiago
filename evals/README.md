# Evals Suite - Chatbot "Yifan"

Suite de evaluaciones profesionales para el chatbot de CV que habla como Yifan.
...
```bash
CHAT_API_URL=https://xueyifan.io/api/chat npm run evals
```
