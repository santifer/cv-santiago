...
export const careerOpsContent = {
  es: {
    ...
    header: {
      kicker: 'Case Study: De proyecto personal a 40.0K+ stars',
      h1: 'Career-Ops: Cómo un Agente IA Automatizó Mi Búsqueda de Empleo',
      subtitle: 'Construí un sistema multi-agente para automatizar mi búsqueda de empleo. Funcionó: ahora soy Head of Applied AI. Luego lo abrí como open source y se hizo viral — 40.0K+ estrellas en GitHub.',
    ...
    sections: {
      intro: {
        hook: 'Construí un sistema de IA para buscar trabajo. Funcionó — ahora soy Head of Applied AI. Luego lo publiqué en GitHub y explotó: 40.0K+ estrellas, viral, artículos en Francia, China y Corea. La primera semana buscando trabajo en IA lo hice todo manual. La segunda semana ya no aplicaba — estaba construyendo Career-Ops.',
      ...
      results: {
        ...
        aftermath: {
          ...
          body: 'Cuando dejé de necesitar Career-Ops, lo publiqué en GitHub. En una semana pasó de repositorio privado a viral — 40.0K+ estrellas, 5K+ forks, y artículos en blogs de Francia, China y Corea que no me conocían de nada. Se formó una comunidad de más de 2.000 personas en Discord que se ayudan entre ellas a configurar y adaptar el sistema. El proyecto acabó demostrando más competencias que cualquier proceso de selección.',
          highlights: [
      ...
      lessons: {
        ...
        items: [
          ...
          },
          {
            ...
            detail: 'Career-Ops fue privado mientras lo usaba. Cuando conseguí el trabajo, lo publiqué. En una semana tenía 40.0K estrellas. La lección: el mejor momento para abrir un proyecto es cuando ya demostró su valor en producción real.',
          },
          {
      ...
      cta: {
        ...
        communityBody: '2.000+ builders ya usan Career-Ops y comparten tips, plantillas y configuraciones en Discord.',
  ...
  en: {
    ...
    header: {
      kicker: 'Case Study: From side project to 40.0K+ stars',
      h1: 'Career-Ops: How I Built an AI Job Search System That Got Me Hired',
      subtitle: 'I built a multi-agent system to automate my job search. It worked — I am now Head of Applied AI. Then I open-sourced it and it went viral — 40.0K+ GitHub stars.',
    ...
    sections: {
      intro: {
        hook: 'I built an AI system to search for a job. It worked — I am now Head of Applied AI. Then I published it on GitHub and it exploded: 40.0K+ stars, viral, articles in France, China, and Korea. Week one of my AI job search was all manual. By week two I had stopped applying — I was building Career-Ops.',
      ...
      results: {
        ...
        aftermath: {
          ...
          body: 'When I no longer needed Career-Ops, I published it on GitHub. In one week it went from private repo to viral — 40.0K+ stars, 5K+ forks, and articles in blogs from France, China, and Korea by people who had never heard of me. A community of 2,000+ people formed on Discord, helping each other configure and adapt the system. The project ended up demonstrating more competencies than any hiring process could.',
          highlights: [
      ...
      lessons: {
        ...
        items: [
          ...
          },
          {
            ...
            detail: 'Career-Ops was private while I was using it. When I got the job, I published it. One week later it had 40.0K stars. The lesson: the best time to open-source a project is when it has already proven its value in real production.',
          },
          {
      ...
      cta: {
        ...
        communityBody: '2,000+ builders already use Career-Ops and share tips, templates, and setups on Discord.',
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'I did — Santiago Fernández de Valderrama (santifer). I built it for my own AI job search after spending 16 years founding and selling a phone repair business. The system evaluated 631 offers and helped me land my current role as Head of Applied AI. When I no longer needed it, I published it as open source. In one week it reached 40.0K+ GitHub stars. The Discord community is now 2,000+ people: discord.gg/8pRpHETxa4',
        },
      ],
    },
  },
