...
export const aboutContent = {
  es: {
    ...
    seo: {
      ...
      description: 'Head of Applied AI. Creador de career-ops (60.8K+ ⭐ en GitHub). Construye sistemas IA en producción. Fundador de Santifer iRepair (30.000+ reparaciones, exit 2025).',
    },
    ...
    subtitle: 'Applied AI Operator · Founder · Builder of career-ops (60.8K+ ⭐)',
    ...
    projects: [
      ...
      { name: 'La historia', desc: 'La búsqueda de empleo como pipeline operado: 740 evaluadas → 1 oferta, y the reversal', href: '/historia' },
  ...
  en: {
    ...
    seo: {
      title: 'Santiago Fernández de Valderrama | Head of Applied AI · Builder of career-ops',
      description: 'Head of Applied AI. Creator of career-ops (60.8K+ ⭐ on GitHub). Builds production AI systems. Founded Santifer iRepair (30,000+ repairs, exit 2025).',
    },
    heading: 'Santiago Fernández de Valderrama',
    ...
    bio: [
      ...
      'Builds production AI systems: career-ops (multi-agent job search system, 60.8K+ GitHub stars), a Self-Healing Chatbot with 71 automated evals and 6-layer jailbreak defense, the omnichannel AI agent Jacobo (n8n + ElevenLabs + tool calling, sold with the business), and a custom Business OS with 12 Airtable bases and 2,100 fields.',
    ...
    projects: [
      ...
      { name: 'The story', desc: 'The job search as an operated pipeline: 740 evaluated → 1 offer, and the reversal', href: '/story' },
